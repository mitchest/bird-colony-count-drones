...
var filename = function (){
  return '/users/mitchest/drone-nest-count/maczoo_rf_rscale' + 
...
// 1. Loading the data
// load image data
var ortho = ee.Image("users/mitchest/drone-nest-count/macmarsh_zoo_ortho")
...
var nests = ee.FeatureCollection("ft:1zJh7fm9JdCcsqoPiVhx5Np0cw3hMuAbtIvPy-t4r") //identified nests
var colony = ee.FeatureCollection("users/mitchest/drone-nest-count/maczoo_colony_boundary") //colony boundary

var training_sites = ee.FeatureCollection("users/mitchest/drone-nest-count/maczoo_training_points") //potnetial image training sites
