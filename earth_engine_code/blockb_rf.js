// Booligal - lachlan river, block bank
// Table of Contents
...
var filename = function (){
  return '/users/mitchest/drone-nest-count/blockb_rf_rscale' + 
...
// 1. Loading the data
// load image data
var ortho = ee.Image("users/mitchest/drone-nest-count/booligal_blockbank_ortho")
...
var nests = ee.FeatureCollection('ft:15ajK6Jpd5dBj1SzCn2mzjAAR9mlkRFkUiGMLyk92') //identified nests
var colony = ee.FeatureCollection("users/mitchest/drone-nest-count/blockb_colony_boundary") //colony boundary

var training_sites = ee.FeatureCollection("users/mitchest/drone-nest-count/blockb_training_sites") //potnetial image training sites
